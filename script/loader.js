...
var nav_bar_code = `<nav>
                            ...
                            <li class="dropdown_center">
                                <ul class="center_content">
                                 <li class="dropdown_services_list">
                                    ...
                                    <li class="dropdown_services_list">
                                        <a href="https://everestmena.com/Insights/defending-against-cyber" class="services_link">
                                            <div class="service_shape"></div>
                                            <div class="dropdown_service">
 ...
 <li class="link_text">
               ...
               <li class="link_text">
                ...
                <li class="link_text">
                    <a href="https://everestmena.com/Insights/defending-against-cyber">Cyber Security</a>
                </li>
                <li class="link_text">
